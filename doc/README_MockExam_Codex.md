...
- Dashboard : `/fide/dashboard#exams` (section “Mock exam”)
- Détail compilation : `/mock-exams/[compilationId]`
- Runner : `/mock-exams/[compilationId]/runner` (**page unique**, pas de `/resume`)
...
2. Runner `/mock-exams/[compilationId]/runner` (page unique) + store Zustand + écrans (cf. docs UX)
