...
- `/dashboard/mock-exams/[compilationId]`
...
## 3) Comportement au mount de `/exam/[compilationId]`
...
- Route `/exam/[compilationId]` peut être implémentée en App Router (`app/exam/[compilationId]/page.tsx`).
