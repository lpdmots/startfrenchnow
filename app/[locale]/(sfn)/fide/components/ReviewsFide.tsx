...
/* const comments = [
    {
        ...
        results: (
            <p className="mb-0 italic">
                Before: <b>B1</b> - After: <b>B1</b> - Score: <b>100%</b> - 6 lesson hours
            </p>
        ),
    },
    {
        ...
        results: (
            <p className="mb-0 italic">
                Before: <b>A2</b> - After: <b>B1</b> - Score: <b>B1</b> - 8 lesson hours
            </p>
        ),
    },
    {
        ...
        results: (
            <p className="mb-0 italic">
                Before: <b>B1</b> - After: <b>B1</b> - Score: <b>93%</b> - 2 lesson hours
            </p>
        ),
    },
]; */
