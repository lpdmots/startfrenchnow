...
export function FidePageTipsSection() {
    ...
    return (
        <section id="fide-tips" className="bg-neutral-800 !pt-16 !pb-10 lg:!pt-20 lg:!pb-12">
            <div className="max-w-7xl m-auto px-4 lg:px-8">
                <h2 className="display-2 mb-4 text-neutral-100">{t.rich("title", rich)}</h2>
                <p className="mb-0 max-w-[75ch] text-left text-neutral-200">{t.rich("intro", richWithBreak)}</p>
                ...
                <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] items-start">
                    ...
                    <div className="space-y-6">
                        <div className="border-t border-secondary-6 pt-4">
                        ...
                        <div className="border-t border-secondary-2 pt-4">
                        ...
                        <div className="border-t border-secondary-5 pt-4">
