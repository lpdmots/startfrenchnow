            ...
            <div className="mx-auto w-full max-w-7xl px-4 lg:px-8">
                <div className="rounded-3xl border border-neutral-300 bg-gradient-to-br from-neutral-100 to-secondaryShades-6 p-5 md:p-7 lg:p-10">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
                        <Link
                            href="/fide#plans"
                            className="group rounded-2xl border border-neutral-300 bg-neutral-100 p-5 !no-underline shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-secondary-6 hover:shadow-md"
                        >
                            ...
                            <p className="mb-0 inline-flex items-center gap-2 text-sm font-semibold text-secondary-6">
                                Voir le pack
                        ...
                        <Link
                            href="/fide#ContactForFIDECourses"
                            className="group rounded-2xl border border-neutral-300 bg-neutral-100 p-5 !no-underline shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-secondary-2 hover:shadow-md"
                        >
                            ...
                            <p className="mb-0 inline-flex items-center gap-2 text-sm font-semibold text-secondary-2">
