                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(300px,400px)_minmax(0,1fr)] lg:gap-12">
                    <SlideFromLeft>
                        <div className="lg:sticky lg:top-24 lg:self-start">
                            <p className="mb-2 inline-flex rounded-full bg-secondaryShades-1 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-neutral-800">Épreuves test FIDE</p>
                            <h2 className="display-2 mb-4 text-neutral-100">
                                Les mêmes <span className="heading-span-secondary-1">épreuves</span> que dans le test FIDE ?
                            </h2>
                            <p className="mb-4 text-base text-neutral-200 md:text-lg">
                                Oui. Vous retrouvez la même logique de passation: nous découpons le test FIDE en épreuves et vous vous entraînez avec les mêmes types de tâches.
                            </p>
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:gap-12">
                            ...
                            <article className="rounded-2xl bg-neutral-800">
                                ...
                                <div className="mb-3 grid grid-cols-1 gap-2 lg:grid-cols-[1fr_auto_1fr] lg:items-center lg:gap-3">
                                    <div className="min-w-0 rounded-xl border border-solid border-neutral-400 p-3">
                                        <p className="mb-1 inline-flex rounded-full bg-neutral-200 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-neutral-800">Dans le test FIDE</p>
                                    ...
                                    <div className="min-w-0 rounded-xl border border-solid border-secondary-4 p-3">
                                        ...
                                        <p className="mb-0 text-base text-neutral-200">Vous enregistrez votre audio ou vous conversez en situation réelle avec l&apos;IA selon le type d&apos;exercice.</p>
                                    </div>
                                </div>
                                <Image src="/images/parler-mock-exam.png" alt="Capture de l'épreuve de production orale" width={760} height={680} className="h-auto w-full rounded-lg object-contain" />
                            </article>
                        </SlideFromBottom>
                        ...
                        <SlideFromBottom duration={0.35} delay={0.2}>
                            <article className="rounded-2xl bg-neutral-800">
                                ...
                                <Image src="/images/comprendre-mock-exam.png" alt="Capture de l'épreuve de compréhension orale" width={760} height={680} className="h-auto w-full rounded-lg object-contain" />
                            </article>
                        </SlideFromBottom>
                        ...
                        <SlideFromBottom duration={0.35} delay={0.3}>
                            <article className="rounded-2xl bg-neutral-800">
                                ...
                                <Image src="/images/lire-ecrire-mock-exam.png" alt="Capture de l'épreuve de lecture / écriture" width={760} height={680} className="h-auto w-full rounded-lg object-contain" />
                            </article>
                        </SlideFromBottom>
                    </div>
                </div>
