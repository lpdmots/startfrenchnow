...
const mockExamFaqItems = [
    {
        title: "L'examen blanc reprend-il réellement le format FIDE ?",
        content: (
            <p>
                Oui. L&apos;examen blanc est très fidèle au format FIDE, avec des consignes et un déroulé comparables. L&apos;objectif est de vous placer dans des conditions au plus proche du réel,
                afin de réduire le stress lié à l&apos;inconnu et de vous aider à comprendre précisément ce qui vous attend le jour de l&apos;examen.
            </p>
        ),
    },
    {
        title: "Quelles épreuves sont incluses ?",
        content: <p>Les trois épreuves sont proposées: Parler, Comprendre et Lire/Écrire. L&apos;ordre de passation est également respecté, afin de rester au plus proche des conditions réelles.</p>,
    },
    {
        title: "Quels parcours sont disponibles ?",
        content: (
            <p>
                Vous pouvez passer les parcours A1-A2 ou A2-B1, selon votre objectif. Cet examen blanc vous permet de vous situer clairement et de fixer un objectif réaliste pour votre progression.
            </p>
        ),
    },
    {
    ...
    {
        title: "Puis-je passer l'examen sur mobile ?",
        content: (
            <p>
                Oui, mobile et ordinateur sont possibles. Tout le contenu Start French Now est multi-format. Pour la passation de l&apos;examen, nous recommandons toutefois l&apos;ordinateur, qui
    ...
    },
    {
        ...
        content: (
            <p>
                Comme dans l&apos;examen FIDE, vous recevez un pourcentage de réussite, un score et un niveau estimé (A1/A2/B1) pour chaque épreuve de l&apos;examen. Vous obtenez également des axes
    ...
    },
    {
        ...
        content: (
            <p>
                ...
                de l&apos;examen, régulièrement mis à jour, ainsi que des dizaines d&apos;entraînements, de cours de français et de cours spécifiques FIDE.
            </p>
        ),
    },
    {
