...
export function PrivateCoursesNextStepsSection({ locale }: { locale: string }) {
    const t = useTranslations("Fide.PrivateCoursesNextSteps");
    const rich = {
        ...intelRich(),
                ...
                <div className="p-0">
                    <SlideFromBottom delay={0.05} duration={0.35}>
                        <div className="mx-auto mb-8 max-w-3xl text-center">
                            <p className="mb-3 inline-flex rounded-full bg-secondary-2 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-neutral-100">{t("badge")}</p>
