        ...
        <div className="inner-container _600px---tablet center">
            <div className="inner-container _500px---mbl center overflow-hidden">
                {vocabItems.map((vocabItem, index) => {
                    const { french, english, soundFr, noteFr, noteEn, nature, example, image, alternatives } = vocabItem;
                    ...
                    return (
                        <div className="my-12" key={index}>
                            ...
                            {!!alternatives?.length && (
                                <p>
                                    <span className="underline">Alternatives:</span> <b style={{ color: CATEGORIESCOLORS[category || "tips"] }}>{alternatives.join(" - ")}</b>
                                </p>
                            )}
