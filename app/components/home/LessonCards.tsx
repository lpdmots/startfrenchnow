            ...
            <div className="grid-3-columns m-auto">
                {lessons.map(({ image, title, description, price, difficulty, time, label, reduction, link }) => (
                    <Link href={link} key={title} className="card link-card flex flex-col">
                        ...
                        <h4 className="font-bold px-4">{title}</h4>
                        ...
                        <div>
                            <div className="flex justify-center items-center px-4">
                                <div className="flex items-center mr-4">
                                    <AiFillSignal className=" mr-2" style={{ fontSize: "1.5rem" }} />
                            ...
                            <p className="mb-6 text-center px-4">{label}</p>
                        </div>
                    </Link>
                ))}
                ...
                <div className="card card-secondary-1 flex-vertical-center card-contact-featured lg:!hidden">
                    ...
                    <div className="text-center">
                        ...
                        <a href="/contact" className="btn-primary width-100 w-button">
                            <span className="line-rounded-icon link-icon-left text-medium"></span>Contact me
                        </a>
                    </div>
                </div>
            </div>
