...
import { Response, SimpleQuestion } from "@/app/types/sfn/blog";
...
const OrderLayout = ({ _key }: { _key: string }) => {
    ...
    const currentQuestion: SimpleQuestion = useMemo(() => questions[questionIndex], []); // eslint-disable-line react-hooks/exhaustive-deps
