"use client";
import { SimpleQuestion } from "@/app/types/sfn/blog";
...
import useImageDimensions from "@/app/hooks/exercises/simpleExercise/useImageDimensions";

const cloudFrontDomain = process.env.NEXT_PUBLIC_CLOUD_FRONT_DOMAIN_NAME;

export default function QuestionPrompt({ currentQuestion, htmlElement, handler }: { currentQuestion: SimpleQuestion; htmlElement: "disabledInput" | "select" | "input"; handler?: HandlerFunction }) {
...
const RenderImageMap = ({ currentQuestion, handler }: { currentQuestion: SimpleQuestion; handler?: HandlerFunction }) => {
