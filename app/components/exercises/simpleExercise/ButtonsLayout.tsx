...
import { SimpleExercise } from "@/app/types/sfn/blog";
...
const getButtonColor = (response: any, showAnswers: boolean, selectedButton: string | null, data: SimpleExercise | null) => {
    ...
    if (showAnswers) {
        ...
        if (isSelected) return COLORVARIABLESSHADES[data?.color || "blue"];
