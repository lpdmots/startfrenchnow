...
import { getTimeData } from "@/app/lib/utils";
...
export function calculateTimes(calendlyEvents: CalendlyEvent[], totalAvailableMinutes: number) {
...
export const getFormattedData = ({ calendlyEvents, ...rest }: CalendlyData) => {
